                                            ...
                                            <div class="row">
                                                <div class="dropdown__content col-lg-2">
                                                    <ul class="menu-vertical">
                                                        ...
                                                        <li>
                                                            <a href="{{url('/services/electrical-data')}}">
                                                                Electrical - DATA
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="{{url('/services/cabinet-making')}}">
                                                                Cabinet Making
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="{{url('/services/security-surveillance')}}">
                                                                Security Surveillance
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="{{url('/services/property-maintenance')}}">
